...
// - out1 will contain all words present in str1 but NOT present in str2.
// - out2 will contain all words present in str2 but NOT present in str1.


const splitArray = function (str1, str2) {
  let out1 = str1.toLowerCase().split(' ')
  let out2 = str2.toLowerCase().split(' ')
  out1 = out1.filter(c => str2.includes(c))
  out2 = out2.filter(c => str1.includes(c))
